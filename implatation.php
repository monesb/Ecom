...
<body>
    ...
    <button onclick="window.location.href = 'neuralink.php';">Neuralink</button>
        ...
        <button onclick="window.location.href = 'implatation.php';">IMPLATATION</button>
        <button onclick="window.location.href = 'testN.php';">EXPERIENCE</button>
        </ul>
        <header>
            <div class="title">
            <h1><font color="red">Implantation</font></h1>
                <h3>Concrètement, il s’agit d’implanter au sein du cerveau. Ces signaux cérébraux sont transmis sans fil à un dispositif externe, qui les décode.
                </h3>
