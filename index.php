...
try {
    ...
    $filters = [
        'filter_souris' => 'Souris',
        'filter_clavier' => 'Clavier',
        'filter_carte_mere' => 'Carte mère',
        'filter_ordinateur_portable' => 'Ordinateur portable',
        'filter_ordinateur_fixe' => 'Ordinateur fixe',
        'filter_ecran_pc' => 'Ecran PC'
    ];

    foreach ($filters as $key => $value) {
        if (isset($_GET[$key])) {
            $filterConditions[] = "description = '$value'";
        }
    }
...
<div class="container mt-5">
    ...
    <form method="get" id="filterForm" class="mb-4">
        <div>
            ...
            <label><input type="checkbox" name="filter_carte_mere" <?php echo isset($_GET['filter_carte_mere']) ? 'checked' : ''; ?>> Carte mère</label>
            <label><input type="checkbox" name="filter_ordinateur_portable" <?php echo isset($_GET['filter_ordinateur_portable']) ? 'checked' : ''; ?>> Ordinateur portable</label>
            <label><input type="checkbox" name="filter_ordinateur_fixe" <?php echo isset($_GET['filter_ordinateur_fixe']) ? 'checked' : ''; ?>> Ordinateur fixe</label>
            <label><input type="checkbox" name="filter_ecran_pc" <?php echo isset($_GET['filter_ecran_pc']) ? 'checked' : ''; ?>> Ecran PC</label>
        </div>
